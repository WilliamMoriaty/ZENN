...
echo "=================================="
echo "SmolLM2-360M Full Fine-tuning on AG News with DDP"
echo "=================================="
...
cd /home/spw5793/work/ZENN/AgNews/SmolLM2_all_360
...
echo "  Model: SmolLM2-360M (from Hugging Face Hub)"
echo "  Pretrained: HuggingFaceTB/SmolLM2-360M"
