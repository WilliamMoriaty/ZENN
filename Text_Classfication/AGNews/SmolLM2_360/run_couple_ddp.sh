...
echo "=================================="
echo "SmolLM2-360M CoupledModel Training on AG News"
echo "=================================="
...
cd /home/spw5793/work/ZENN/AgNews/SmolLM2_360
...
echo ""
echo "  Expected Memory: ~36GB per GPU (2 models + LoRA)"
echo "  Expected Speed: ~8-10 min/epoch"
echo ""

# Run DDP training with CoupledModel
python train_couple_ddp.py \
    --output-dir ./output_coupled_lora_agnews_K4 \
...
echo ""
echo "Output files saved to: ./output_coupled_lora_agnews_K2/"
...
echo "  ✓ Fine-tuning: LoRA (~2M trainable params, <0.3% of total)"
echo "  ✓ Temperature: K=2 learnable temps in [0.1, 10.0] (K=3,seed=42)"
...
echo "  ✓ Memory: ~36GB/GPU, Speed: ~8-10 min/epoch"
