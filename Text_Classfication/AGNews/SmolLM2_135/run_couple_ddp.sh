#!/bin/bash
#SBATCH --job-name=smollm2_coupled_agnews
...
# ============================================================================
# SmolLM2-135M CoupledModel Training with Learnable Temperature
# ============================================================================
...
echo "=================================="
echo "SmolLM2-135M CoupledModel Training on AG News"
echo "=================================="
...
cd /home/spw5793/work/ZENN/AgNews/SmolLM2_135
...
echo "  Model: SmolLM2-135M (135M parameters each)"
echo "  Dataset: AG News (4 classes, 120,000 train samples)"
...
echo "  Global Batch Size: 256 (32 x 4 x 2)"
echo "  Steps per Epoch: ~469"
echo "  Epochs: 10"
echo "  Max Sequence Length: 512"
echo "  Mixed Precision: bfloat16"
echo ""
echo "  Expected Memory: ~18GB per GPU (2 models + LoRA)"
echo "  Expected Speed: ~4-5 min/epoch"
echo ""
...
echo "  ✓ Model: SmolLM2-135M (135M × 2 = 270M total params)"
echo "  ✓ Dataset: AG News (4 classes, 120,000 samples)"
echo "  ✓ Fine-tuning: LoRA (~1M trainable params, <0.4% of total)"
echo "  ✓ Temperature: K=5 learnable temps in [0.1, 10.0]"
echo "  ✓ Training: EM with worst-T optimization"
echo "  ✓ Evaluation: Posterior q(T|x,y) weighted accuracy"
echo "  ✓ Batch size: 32/GPU, Global: 256, Steps/epoch: 469"
echo "  ✓ Memory: ~18GB/GPU, Speed: ~4-5 min/epoch"
