#!/usr/bin/env python3
"""
SmolLM2-360M CoupledModel training on BBC News with DDP, LoRA, and Temperature Learning
...
def train_worker(rank, world_size, args):
    ...
    if is_main_process():
        print(f"\n{'='*80}")
        print(f"SmolLM2-360M CoupledModel Training on BBC News with DDP")
        print(f"{'='*80}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='SmolLM2-360M CoupledModel Training with DDP')
