#!/usr/bin/env python3
"""
SmolLM2-135M training on BBC News with DDP and LoRA support
...
def train_worker(rank, world_size, args):
    ...
    if is_main_process():
        print(f"\n{'='*80}")
        print(f"SmolLM2-135M Training on BBC News with DDP")
        print(f"{'='*80}")
    ...
    if is_main_process():
        print(f"  ✓ Loaded SmolLM2-135M model from {model_name}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Train SmolLM2-135M on BBC News with DDP and LoRA support')
