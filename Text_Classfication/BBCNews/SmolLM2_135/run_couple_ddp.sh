#!/bin/bash
#SBATCH --job-name=smollm2_coupled_bbcnews
...
echo "=================================="
echo "SmolLM2-135M CoupledModel Training on BBC News"
echo "=================================="
...
cd /home/spw5793/work/ZENN/BBCNews/SmolLM2_135
...
echo ""
echo "  Expected Memory: ~16GB per GPU (2 models + LoRA)"
echo "  Expected Speed: ~25-30s/epoch"
echo ""
...
echo ""
echo "Output files saved to: ./output_coupled_lora_bbc/"
...
echo "  ✓ Temperature: K=4 learnable temps in [0.1, 10.0]"
...
echo "  ✓ Memory: ~16GB/GPU, Speed: ~25-30s/epoch"
