#!/bin/bash
#SBATCH --job-name=smollm2_lora_agnews
...
# ============================================================================
# SmolLM2-135M LoRA Fine-tuning Configuration
# ============================================================================
...
echo "=================================="
echo "SmolLM2-135M with LoRA on BBC News with DDP"
echo "=================================="
...
echo "  Model: SmolLM2-135M (135M parameters)"
...
echo "  Target Memory: ~8GB per GPU (reduced batch size)"
echo "  Expected Speed: ~10-15s/epoch (small dataset!)"
echo ""

# Run DDP training with LoRA (Optimized for Small Dataset)
python train_smol_ddp.py \
    --output-dir ./output_smollm2_lora_bbc \
    --epochs 30 \
    --batch-size 4 \
    --grad-accum-steps 1 \
    --grad-clip 1.0 \
...
echo ""
echo "Output files saved to: ./output_smollm2_lora_bbc/"
...
echo "  ✓ Model: SmolLM2-135M (Llama architecture)"
...
echo "  ✓ Trainable parameters: ~0.5M (<0.4% of total)"
...
echo "  ✓ Memory per GPU: ~8GB"
echo "  ✓ Expected speed: ~10-15s/epoch"
echo "  ✓ GPUs: 4"
