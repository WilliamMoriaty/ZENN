...
All codes are simulated by the shell scripts which include the details of hyperparameter and model introduction. The results about image and text classification tasks have been presented using the state-of-art models:
