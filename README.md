...
All simulations were performed on a server equipped with eight NVIDIA A100 GPUs. Each code is simulated by the corresponding shell script which includes the complete details of hyperparameter and model introduction. The results about image and text classification tasks have been presented using the state-of-art models:
